...
init -1 python hide:
    ...
    config.window_title = u"Storybro's Magically Lewd Sleepover Adventure"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Storybro's Magically Lewd Sleepover Adventure"
    config.version = "0.0"
...
python early:
    config.save_directory = "Storybro's Magically Lewd Sleepover Adventure-1409091288"
